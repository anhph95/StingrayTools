#!/usr/bin/env bash
###############################################################################
# Run post-inference YOLO abundance processing on a local machine or HPC node.
###############################################################################
...
VENV_DIR="/mnt/vast/nes-lter/Stingray/data/envs/stingraytools-yolo-abundance"
...
YOLO_CSV="/mnt/vast/nes-lter/Stingray/data/yolo_abundance_work/YYYYMMDD_EN706_yolo_labels.csv"
...
MEDIA_OUT_DIR="/mnt/vast/nes-lter/Stingray/data/media_list/ISIIS1"
FPS="15"
...
require_value "YOLO_CSV" "$YOLO_CSV"
...
mkdir -p "$(dirname "$YOLO_CSV")" "$(dirname "$ABUNDANCE_OUT_CSV")"
